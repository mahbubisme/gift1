...
$data_create = '{"address":"","birthDate":"1990-11-11","debug":false,"deviceId":'.$deviceid2.',"email":'.$random_email.',"firstName":"","fullName":'.$random_name.',"gender":"F","lastName":"","latitude":0,"longitude":0,"maritalStatus":"M","password":"akun121212","phone":'.$nomorhp.',"postCode":"","registerPonta":true,"token":'.$token2.'}';
